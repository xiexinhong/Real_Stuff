...
import org.xxh.realstuff.utils.DensityUtils;

/**
 * @author xiexinhong (xiexinhong@meituan.com) on 16/11/22.
 */
...
public class PullToZoomScrollView extends ScrollView{
    ...
    private void init(Context context) {
        ...
        mTopViewHeight = (int)(screenWidth / ASPECT_RATIO);
        Log.e("xxh","mTopViewHeight = "+mTopViewHeight);
